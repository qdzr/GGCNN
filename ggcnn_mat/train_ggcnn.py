...
def parse_args():
    ...
    parser.add_argument('--network', type=str, default='ggcnn', choices=['ggcnn', 'ggcnn2'], help='Network Name in .models')
    # 数据集
    parser.add_argument('--dataset-path', default='E:/dataset/cornell', type=str, help='数据集路径')
    # 训练超参数
    ...
    # description
    parser.add_argument('--description', type=str, default='redwallbot', help='Training description')
    # 从已有网络继续训练
    parser.add_argument('--goon-train', type=bool, default=False, help='是否从已有网络继续训练')
    parser.add_argument('--model', type=str, default='output/models/220728_0920_redwallbot/epoch_0081_acc_0.2838.pth', help='保存的模型')
