...
if __name__ == '__main__':
    dataset_path = 'E:/dataset/clutter'
    # 加载训练集
    print('Loading Dataset...')
    train_dataset = GraspDataset(dataset_path, start=0.0, end=0.9, argument=True, output_size=300)
    ...
    for x, y in train_data:
        ...
        # cv2.imwrite('E:/ggcnn_own/data/' + str(count) + '_region.png', im_grasp_region)
        # cv2.imwrite('E:/ggcnn_own/data/' + str(count) + '_line.png', im_grasp_line)